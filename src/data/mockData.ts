...
export const blogs = [
  ...
  },
  {
    ...
    content: `
      ...
      <p class="text-slate-700 mb-6">We recommend a "Hybrid Approach"—combining standard textbooks for concepts with our online courses for exam-oriented practice.</p>

      <h2 class="text-2xl font-bold text-slate-900 mb-4">1. Nursing Subjects (Professional Ability)</h2>
      <p class="mb-4 text-slate-700">Since this section carries 70 marks, you cannot afford to miss any topic. The following books are considered the "Bible" for nursing competitive exams:</p>
      <ul class="list-disc pl-5 space-y-2 mb-6 text-slate-700">
        <li><strong>Target High</strong> (Muthuvenkatachalam): Excellent for MCQs and image-based questions.</li>
        <li><strong>PR Yadav (Vol 1 & 2)</strong>: Great for clearing basics and practicing subject-wise questions.</li>
        <li><strong>Saunders Comprehensive Review for NCLEX-RN</strong>: For deep conceptual clarity, especially for Medical-Surgical Nursing.</li>
      </ul>
      ...
      <p class="mb-4 text-slate-700">For the non-technical section (20 Marks), you need concise resources:</p>
      <ul class="list-disc pl-5 space-y-2 mb-6 text-slate-700">
        <li><strong>Lucent's General Knowledge</strong>: Sufficient for History, Geography, and Polity.</li>
        <li><strong>Fast Track Objective Arithmetic (Rajesh Verma)</strong>: Best for quick math tricks and formulas.</li>
        <li><strong>Pratiyogita Darpan</strong>: Monthly magazine for Current Affairs.</li>
      </ul>

      <h2 class="text-2xl font-bold text-slate-900 mb-4">3. General Science</h2>
      <p class="mb-4 text-slate-700">For the 10 marks of Science (Physics, Chemistry, Biology), stick to the basics:</p>
      <ul class="list-disc pl-5 space-y-2 mb-6 text-slate-700">
        <li><strong>NCERT Textbooks (Class 9 & 10)</strong>: The most authentic source for RRB exams.</li>
        <li><strong>Encyclopedia of General Science (Arihant)</strong>: A good compilation for competitive exams.</li>
      </ul>
      ...
      <div class="my-8 p-6 bg-blue-50 border border-blue-200 rounded-lg text-center shadow-sm">
        ...
        <p class="text-sm text-blue-700 mb-4">Books are static, but exams are dynamic. Solve previous year papers to know the real trend.</p>
      ...
      <p class="text-slate-700">Remember, buying books is easy, but reading them requires discipline. Make a schedule, stick to limited resources, and revise multiple times.</p>
    `
  },
  {
    ...
    content: `
      ...
      <p class="mb-4 text-slate-700">The cut-off varies every year based on:</p>
      <ul class="list-disc pl-5 space-y-2 mb-6 text-slate-700">
        <li><strong>Number of Vacancies:</strong> Higher vacancies usually lead to a slightly lower cut-off.</li>
        <li><strong>Difficulty Level of Exam:</strong> A tough paper brings the cut-off down.</li>
        <li><strong>Number of Applicants:</strong> With rising competition, the cut-off is expected to rise in 2026.</li>
        <li><strong>Normalization:</strong> Since the exam may be held in multiple shifts, normalization plays a huge role.</li>
      </ul>

      <h2 class="text-2xl font-bold text-slate-900 mb-4">Previous Year Cut-off Trends (2019)</h2>
      <p class="mb-4 text-slate-700">Here is a rough idea of the cut-off marks (out of 100) for major zones in the last recruitment cycle:</p>
        ...
        <table class="w-full text-sm text-left border border-slate-200">
          <thead class="bg-slate-100 text-slate-700 uppercase">
            <tr>
              ...
              <th class="px-4 py-2 border">UR (General)</th>
              <th class="px-4 py-2 border">OBC</th>
              <th class="px-4 py-2 border">SC</th>
              <th class="px-4 py-2 border">ST</th>
            </tr>
          </thead>
          <tbody>
            <tr>
              <td class="px-4 py-2 border">RRB Ajmer</td>
              <td class="px-4 py-2 border">72.5</td>
              <td class="px-4 py-2 border">68.2</td>
              <td class="px-4 py-2 border">61.5</td>
              <td class="px-4 py-2 border">58.4</td>
            </tr>
            <tr>
              <td class="px-4 py-2 border">RRB Mumbai</td>
              <td class="px-4 py-2 border">69.8</td>
              <td class="px-4 py-2 border">65.4</td>
              <td class="px-4 py-2 border">59.2</td>
              <td class="px-4 py-2 border">55.1</td>
            </tr>
            <tr>
              <td class="px-4 py-2 border">RRB Chennai</td>
              <td class="px-4 py-2 border">71.2</td>
              <td class="px-4 py-2 border">67.8</td>
              <td class="px-4 py-2 border">60.5</td>
              <td class="px-4 py-2 border">56.8</td>
            </tr>
            <tr>
              <td class="px-4 py-2 border">RRB Kolkata</td>
              <td class="px-4 py-2 border">74.1</td>
              <td class="px-4 py-2 border">70.5</td>
              <td class="px-4 py-2 border">63.2</td>
              <td class="px-4 py-2 border">59.5</td>
            </tr>
          </tbody>
        </table>
      </div>
      ...
      <div class="my-8 p-6 bg-green-50 border border-green-200 rounded-lg text-center shadow-sm">
        ...
        <p class="text-sm text-green-700 mb-4">Don't guess. Take a full-length mock test and see where you stand today.</p>
      ...
      <p class="mb-4 text-slate-700">Given the increased competition and fewer vacancies compared to 2019, aspirants should aim higher. A safe target score for 2026 would be:</p>
      <ul class="list-disc pl-5 space-y-2 mb-6 text-slate-700">
        <li><strong>General (UR):</strong> 75 - 80 Marks</li>
        <li><strong>OBC:</strong> 72 - 76 Marks</li>
        <li><strong>SC/ST:</strong> 65 - 70 Marks</li>
      </ul>

      <p class="text-slate-700">Do not rely on the minimum qualifying marks (which are just 40% for UR). To get into the merit list, you need to be in the top percentile. Start your preparation with NPrep and aim for 80+.</p>
    `
  }
];
